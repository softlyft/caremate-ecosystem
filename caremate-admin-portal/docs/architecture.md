...
| `/dashboard/community` | Community Network overview |
| `/dashboard/community/profiles` | Community members (canonical profiles) |
| `/dashboard/community/chapters` | Create/update chapters with cascading geography + lead assignment |
| `/dashboard/community/chapters/requests` | Chapter creation requests (if any) |
| `/dashboard/community/events` | Events oversight |
| `/dashboard/community/resources` | Resources oversight |
| `/dashboard/community/recognition` | Badges / certificates + awards |
| `/dashboard/community/reports` | Basic community reports |
...
- Provider upload depends on the external `caremate-provider-ingestion` service
