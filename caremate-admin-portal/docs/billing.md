...
Paid self-serve upgrades (credit against unused Standard) use Edge Functions `quote-upgrade` / `create-upgrade` from the mobile Premium screen — see [Premium & plans](../../caremate-mobile/docs/premium-and-plans.md).

## Cross-Service Relationship

Billing spans multiple services:

- Mobile opens hosted `caremate-payment-gateway/` → Edge Function `create-checkout` (pending payment)
...
**Product rules** (what Free vs Standard vs Family Premium unlocks on mobile): [`caremate-mobile/docs/premium-and-plans.md`](../../caremate-mobile/docs/premium-and-plans.md).
