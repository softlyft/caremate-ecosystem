...
| Ads kill switches + campaigns | Mobile strategy: [`caremate-mobile/docs/ads.md`](../../caremate-mobile/docs/ads.md) · `/dashboard/ads` · slot constants in `src/domains/ads/constants.ts` |
...
- CareMate Community Network oversight (`/dashboard/community/*`) — chapters, members, recognition awards, reports. Contributor UX lives in [`caremate-community-portal`](../../caremate-community-portal/docs/README.md).
...
- Service README: `caremate-admin-portal/README.md`
