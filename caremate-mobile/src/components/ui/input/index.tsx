...
const InputField = React.forwardRef<React.ComponentRef<typeof UIInput.Input>, IInputFieldProps>(
  function InputField({ className, placeholderTextColor = textColors.placeholder, ...props }, ref) {
    return (
      <UIInput.Input
        ref={ref}
