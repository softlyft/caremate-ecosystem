...
During development the code is displayed in the UI. Replace that display with email delivery
before production. Enrollment never creates an Auth user or copies data from `profiles`.
