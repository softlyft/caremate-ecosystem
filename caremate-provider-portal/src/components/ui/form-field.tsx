...
export function FormField({
  ...
  children: ReactNode;
  className?: string;
  /** Tighter spacing for nested or compact forms. */
  compact?: boolean;
  /** Optional trailing control (e.g. forgot-password link). */
...
/** Three-column layout: two fields + trailing submit button (connection request forms). */
