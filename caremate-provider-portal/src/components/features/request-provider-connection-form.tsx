...
export function RequestProviderConnectionForm() {
  ...
  return (
    <form
      ...
      onSubmit={(e) => {
        ...
        startTransition(async () => {
          try {
            await requestProviderConnectionByEmailAction(formData);
            toast.success('Connection request sent — waiting for the provider to approve');
            form.reset();
          } catch (err) {
    ...
    >
      <div className="space-y-2">
        <Label htmlFor="claim_email">Provider claim email</Label>
        <Input
          id="claim_email"
          name="claim_email"
          type="email"
      ...
      <div className="space-y-2">
        ...
        <Textarea
          ...
          name="payer_note"
          rows={1}
          placeholder="e.g. Network onboarding"
